(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('framesync'), require('popmotion'), require('tslib'), require('style-value-types'), require('svelte')) :
    typeof define === 'function' && define.amd ? define(['exports', 'framesync', 'popmotion', 'tslib', 'style-value-types', 'svelte'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Motion = {}, global.sync, global.popmotion, global.tslib, global.styleValueTypes, global.svelte));
}(this, (function (exports, sync, popmotion, tslib, styleValueTypes, svelte) { 'use strict';
    ...
    */
    ...
    const provideScaleCorrection = isCustom => {
    	const fromParent = svelte.getContext(ScaleCorrectionContext) || ScaleCorrectionContext(isCustom);
    	const ctx = ScaleCorrectionContext();
    	svelte.setContext(ScaleCorrectionContext, ctx);
    	setDomContext("ScaleCorrection", isCustom, ctx);
    	svelte.setContext(ScaleCorrectionParentContext, fromParent);
    };
    ...
    const scaleCorrection = () => {
        ...
        const scaleCorrectionContext = svelte.getContext(ScaleCorrectionContext);
        const scaleCorrectionParentContext = svelte.getContext(
    ...
    function instance$x($$self, $$props, $$invalidate) {
    	...
    	const mcc = svelte.getContext(MotionConfigContext) || MotionConfigContext(isCustom);
     ...
     */
    	...
    	svelte.setContext(MotionConfigContext, context);
    ...
    */
    ...
    const useIsPresent = (isCustom=false) => {
        let presenceContext = svelte.getContext(PresenceContext) || PresenceContext(isCustom);
        return derived(presenceContext, $v => $v === null ? true : $v.isPresent)
    };

    const usePresence = (isCustom=false) => {

        const context = svelte.getContext(PresenceContext)||PresenceContext(isCustom);
    ...
    */
    ...
    function instance$w($$self, $$props, $$invalidate) {
    	...
    	const config = svelte.getContext(MotionConfigContext) || MotionConfigContext(isCustom);
    	component_subscribe($$self, config, value => $$invalidate(17, $config = value));
    	const presenceContext = svelte.getContext(PresenceContext) || PresenceContext(isCustom);
    	component_subscribe($$self, presenceContext, value => $$invalidate(16, $presenceContext = value));
    	const lazyContext = svelte.getContext(LazyContext) || LazyContext(isCustom);
    	component_subscribe($$self, lazyContext, value => $$invalidate(20, $lazyContext = value));
    	const mc = svelte.getContext(MotionContext) || MotionContext(isCustom);
    	component_subscribe($$self, mc, value => $$invalidate(14, $mc = value));
    	let parent = get_store_value(mc).visualElement;
    	const layoutGroupId = svelte.getContext(LayoutGroupContext) || LayoutGroupContext(isCustom);
    ...
    */
    ...
    function instance$u($$self, $$props, $$invalidate) {
    	...
    	svelte.setContext(MotionContext, store);
    ...
    */
    ...
    function instance$o($$self, $$props, $$invalidate) {
    	...
    	let mc = svelte.getContext(MotionContext) || MotionContext(isCustom);
    ...
    */
    ...
    function instance$n($$self, $$props, $$invalidate) {
    	...
    	const context = svelte.getContext(MotionContext) || MotionContext(isCustom);
    ...
    */
     ...
     */
    	const a = svelte.getContext(MotionConfigContext) || MotionConfigContext(isCustom);
    	...
    	svelte.onMount(() => $$invalidate(2, mounted = true));
    ...
    */
    ...
    function instance$j($$self, $$props, $$invalidate) {
    	...
    	svelte.onDestroy(() => panSession && panSession.end());
    ...
    */
     ...
     */
    	...
    	svelte.onDestroy(removePointerEndListener);
    ...
    */
    ...
    function instance$e($$self, $$props, $$invalidate) {
    	...
    	svelte.onMount(() => dragControls.mount(visualElement));
    ...
    */
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	const scaleCorrectionContext = svelte.getContext(ScaleCorrectionContext);
    	const scaleCorrectionParentContext = svelte.getContext(ScaleCorrectionParentContext);
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	let { visualElement } = $$props, { props } = $$props, { isCustom } = $$props;
    	const syncLayout = svelte.getContext(SharedLayoutContext) || SharedLayoutContext(isCustom);
    	component_subscribe($$self, syncLayout, value => $$invalidate(2, $syncLayout = value));
    	const framerSyncLayout = svelte.getContext(FramerTreeLayoutContext) || FramerTreeLayoutContext();
    ...
    */
     ...
     */
    			if (isAnimationControls(animate)) {
    				svelte.tick().then(() => animate.subscribe(visualElement)); /*, [animate]*/
    			}
    		}
    	};
    ...
    */
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	svelte.setContext(PresenceContext, context);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const layoutContext = svelte.getContext(SharedLayoutContext) || SharedLayoutContext(isCustom);
    ...
    */
     ...
     */
    	...
    	//$: sc.set(syncContext)
    	svelte.setContext(SharedLayoutContext, sc);
    ...
    */
    ...
    const useCombineMotionValues = (values, combineValues) => {
      ...
      const handler = () => {
        sync__default['default'].update(updateValue, false, true);
      };
    ...
    const useSpring = (source, config = {}, isCustom=false) => {
        ...
        const update = (_source, _config) => {
            value.attach((v, set) => {
                ...
                activeSpringAnimation = popmotion.animate({
                    from: value.get(),
                    to: v,
                    velocity: value.getVelocity(),
                    ..._config,
    ...
    */
    ...
    const useAnimation = () =>{
        ...
        const controls =  animationControls(()=>{
            ...
            const cleanup = {};
            svelte.tick().then(v => cleanup.clean = controls.mount());
            return ()=>{
                cleanup.clean?.();
            }
        });
    ...
    const useCycle = (...items) => {
        ...
        const next = (i) => {
            index = typeof i !== "number" ?
                popmotion.wrap(0, items.length, index + 1) :
                i;
            x.set(items[index]);
        };
        x.next=next;
    ...
    */
    ...
    exports.M = M;
    exports.Mdiv = MotionDiv;
    exports.Motion = motion;
    exports.MotionConfig = MotionConfig;
    exports.MotionConfigContext = MotionConfigContext;
    exports.MotionDiv = MotionDiv;
    exports.MotionSSR = MotionSSR;
